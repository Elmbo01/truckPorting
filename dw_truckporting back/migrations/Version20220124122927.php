...
final class Version20220124122927 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql("INSERT INTO empresa (id, nombre, tipo, password, telefono, cif,imagen) values (1, 'Bubbletube', 'Major Pharmaceuticals', 'Bhldq0y', '444-827-1550', '5610144770463297362','http://dummyimage.com/208x100.png/cc0000/ffffff')");
